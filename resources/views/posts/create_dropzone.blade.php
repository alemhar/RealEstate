                        ...
                        <form role="form" method="post" action="/post" enctype="multipart/form-data" id="createForm" class="dropzone">
                            ...
                            <div class="col-md-6">
                                <div class="form-group col-md-3">
                                        <label class="inlinelabel">Sell :</label><input class="inlineinputs" type="checkbox" name="sell" value="1" checked>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group">
                                    <label>Title</label>
                                    <input class="form-control" type="text" name="subject"  placeholder="Name of listing">
                                </div>
                                <div class="form-group">
                                    <label>Barangay</label>
                                    <input class="form-control" type="text" name="area"  placeholder="Barangay">
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input class="form-control" type="number" name="amount"  placeholder="Price">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="number" name="landarea"  placeholder="Land area(sqm)?">
                                
                                </div>
                                <div class="form-group col-md-6">
                                    <label>House Area<small>(Optional)</small></label>
                                    <input class="form-control" type="number" name="housearea"  placeholder="House area(sqm)?">
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
                                    <label>Bedroom(s)</label>
                                    <input class="form-control" type="number" name="bedroom"  placeholder="Bedrooms?">
                                </div>
                                <div class="form-group col-md-6">
