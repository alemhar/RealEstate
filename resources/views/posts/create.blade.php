    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" method="POST" action="/photo" enctype="multipart/form-data" id="addPhotosForm" class="dropzone">
                            {{ csrf_field() }}
                            <div class="col-md-6">
                                <div class="form-group col-md-3">
                                        <label class="inlinelabel">Sell :</label><input class="inlineinputs" type="checkbox" name="sell" checked>
                                </div>
                                <div class="form-group col-md-3">
                                        <label class="inlinelabel">Rent :</label><input class="inlineinputs" type="checkbox" name="rent">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="area" required placeholder="Barangay">
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <input class="form-control" type="text" name="address" required placeholder="Full Address">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group col-md-6">
                                            ...
                                            <label>Storey</label>
                                            <input class="form-control" type="number" name="storey" id="storey" required placeholder="How many storey?" >
                                            
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
                                    <label >Land Area</label>
                                    <input class="form-control" type="number" name="landarea" required placeholder="Land area(sqm)?">
                                
                                </div>
                                <div class="form-group col-md-6">
                                    <label>House Area<small>(Optional)</small></label>
                                    <input class="form-control" type="number" name="housearea" required placeholder="House area(sqm)?">
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
                                    <label>Bedroom(s)</label>
                                    <input class="form-control" type="number" name="bedroom" required placeholder="Bedrooms?">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Bathroom(s)</label>
                                    <input class="form-control" type="number" name="bathroom" required placeholder="Bathrooms?">
                                </div>
                                <div class="form-group col-md-6">
                                    
                                        <label class="inlinelabel">Garage :</label><input class="inlineinputs" type="checkbox" name="bathroom">
                                        
                                        
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="inlinelabel">Fully Furnished :</label>
                                    <input class="inlineinputs" type="checkbox" name="bathroom">
                                </div>
                                <div style="clear:both"></div>
                                <div class="form-group">
