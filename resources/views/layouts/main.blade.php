...
<div class="container-fluid">    
            ...
            <div class="row">
                <div class="form-group col-lg-12">
                                    ...
                                    <select class="form-control" name="district" id="district" required>
                                        ...
                                        <option>Bacolod</option>
                                        <option>Bacolod-Kalawi<br> (Bacolod-Grande)</option>
                                        ...
                                        <option>President Carlos P. Garcia<br> (Pitogo)</option>
                                        ...
                                        <option>Sultan Naga Dimaporo<br> (Karomatan)</option>
                                        <option>Sultan sa Barongis<br> (Lambayong)</option>
    ...
    <div style="padding-top:5px;" class="container sidebar col-md-9 float-md-right">
        @yield('content')
    </div>    
